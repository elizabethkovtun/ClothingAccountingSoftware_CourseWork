...
namespace CourseWork
{
    public partial class ChoiceOfCategory : Form
    {
        ...
        private void btnNewClothes_Click(object sender, EventArgs e)
        {
            ...
            {
                Forms.AddingClothes civilClothes = new Forms.AddCivilClothes();
                civilClothes.Show();
                this.Close();
            }
            else if (chbMilitaryClothes.Checked == true)
            {
                Forms.AddingClothes militaryClothes = new Forms.AddMilitaryClothes();
            ...
            {
                Forms.AddingClothes overalls = new Forms.AddOveralls();
                overalls.Show();
                this.Close();
            }
        }
        ...
        private void ChoiceOfCategory_Load(object sender, EventArgs e)
        {
